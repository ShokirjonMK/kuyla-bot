...
class Buttons:
    ...
    main_menu_buttons = [
        [Button.inline("Ko'rsatmalar", b"instructions"), Button.inline("Sozlamalar", b"setting")],
        # source_code_button,
        [Button.url("Yaratuvchiga murojaat qilish", url="telegram.me/Khayitovdev")],
    ]

    back_button = Button.inline("<< Asosiy menyuga qaytish", b"back")

    setting_button = [
        [Button.inline("Yadro", b"setting/core")],
    ...
    back_button_to_setting = Button.inline("<< Orqaga", b"setting/back")

    cancel_broadcast_button = [Button.inline("Translatsiyani bekor qilish", data=b"admin/cancel_broadcast")]

    admins_buttons = [
        [Button.inline("Translyatsiya", b"admin/broadcast")],
        [Button.inline("Statistika", b"admin/stats")],
        [Button.inline("Bekor qilish", b"cancel")]
    ]

    broadcast_options_buttons = [
        [Button.inline("Translyatsiya To All Members", b"admin/broadcast/all")],
        [Button.inline("Translyatsiya To Subscribers Only", b"admin/broadcast/subs")],
        [Button.inline("Translyatsiya To Specified Users Only", b"admin/broadcast/specified")],
        [Button.inline("Bekor qilish", b"cancel")]
    ]

    continue_button = [Button.inline("Davom eting", data='membership/continue')]
    ...
    def get_subscription_setting_buttons(subscription):
        if subscription:
            return [
                [Button.inline("Obunani bekor qilish", data=b"setting/subscription/cancel")],
                [Buttons.back_button, Buttons.back_button_to_setting]
            ]
        else:
            return [
                [Button.inline("Obuna boʻling", data=b"setting/subscription/add")],
                [Buttons.back_button, Buttons.back_button_to_setting]
            ]
