...
Follow these steps to set up the `Hurshid-Kuyla-Bot-2024-10-22` project on your system.
...
Open a terminal and clone the `Hurshid-Kuyla-Bot-2024-10-22` repository from GitHub:

```zsh
git clone https://github.com/khayitov-dev/Hurshid-Kuyla-Bot-2024-10-22.git
```
...
```zsh
cd Hurshid-Kuyla-Bot-2024-10-22
...
- Telegram: https://t.me/KhayitovDev
